...
The whole thing follows this flowchart (which is also included in the project files):
<img width="681" height="460" alt="SolarFlowChart drawio" src="https://github.com/user-attachments/assets/f64d1674-231d-44b1-9385-9fcf2f2eba52" />

I have begun work on building the stepper motor for the V2, although I probably wont make changes to any core components until I'm satisfied with the results of the V1 setup.
